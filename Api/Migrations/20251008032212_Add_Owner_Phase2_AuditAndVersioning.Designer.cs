...
namespace Api.Migrations
{
    ...
    [Migration("20251008032212_Add_Owner_Phase2_AuditAndVersioning")]
    partial class Add_Owner_Phase2_AuditAndVersioning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.Splits.SplitPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SplitSessionId", "ParticipantId")
                        .IsUnique();

                    b.ToTable("SplitPayments", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Models.Splits.SplitPayment", b =>
                {
                    b.HasOne("Api.Models.Splits.SplitParticipant", null)
                        .WithMany()
                        .HasForeignKey("ParticipantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Api.Models.Splits.SplitSession", null)
                        .WithMany()
                        .HasForeignKey("SplitSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
